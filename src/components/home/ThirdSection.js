    ...
    return (
        <section className="ebook-third-section">
            <div className="container book-third-section">
                <h2>Stress-Free Amazon Book
                    <br />
                    Publishing –  Focus on<br /> Your Story,<span class="orange-text"> We Handle the Rest!</span>
                </h2>
                <p>AMZ Book Publishing will take care of all the tricky stuff so you can focus on what matters: bringing your story to life.<br /> Reach out to us today and get the benefits of Professional Amazon book publishing services.</p>
            </div>
