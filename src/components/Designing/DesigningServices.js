...
const DesigningServices = () => {
  ...
  const servicesPage1 = [
    { number: "01", text: "Author Website Design", link: "/designing/author-website-design" },
    { number: "02", text: "Logo Design", link: "/designing/logo-design" },
    { number: "03", text: "Stationary Design", link: "/designing/stationery-design" },
    { number: "04", text: "Book Card Design", link: "/designing/business-card-design" },
    { number: "05", text: "Book Printing", link: "/designing/book-printing" },
    { number: "06", text: "Book Illustration", link: "/designing/book-illustrations" },
    { number: "07", text: "Book Interior Formatting", link: "/designing/book-interior-formatting" },
    { number: "08", text: "Letterhead & Envelope Design", link: "/designing/letterhead-envelope-design" },
  ];
